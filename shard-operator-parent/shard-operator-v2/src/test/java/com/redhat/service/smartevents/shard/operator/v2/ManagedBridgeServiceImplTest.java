...
public class ManagedBridgeServiceImplTest {
    ...
    public void managedBridgeCreationTriggersController() {
        ...
        Awaitility.await()
                ...
                .untilAsserted(() -> {
                    ...
                    AuthorizationPolicy authorizationPolicy = fetchBridgeAuthorizationPolicy(bridgeDTO);
    ...
    private AuthorizationPolicy fetchBridgeAuthorizationPolicy(BridgeDTO dto) {
