...
import com.redhat.service.smartevents.shard.operator.v2.reconcilers.ManagedBridgeReconciler;
...
public class ManagerSyncService {
    ...
    @Inject
    ManagedBridgeReconciler managedBridgeReconciler;
    ...
    public void syncUpdatesFromManager() {
        ...
        managedBridgeReconciler.reconcile();
    }
}
